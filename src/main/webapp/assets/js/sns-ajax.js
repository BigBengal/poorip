...
var last_render = function(vo, postPicSeq) {
  ...
  if(postPicSeq!=null) {
   var last_html =               "</div>" +
               ...
               "</div>" +
               "<div class='form-group' style='display:block; text-align:center; width:100%'>" +
                  "<a href='javascript:;'><img alt='삭제' src='/poorip/assets/images/delete-btn.png' style='width: 5%; display:inline-block; float:left' onclick='postDelete(" + vo.postSeq + ")'></a>" +
                     ...
                     "<a href='#sns-edit-form' id='edit-form-tag'><img alt='수정' src='/poorip/assets/images/write-btn.png' style='width: 5%; display:inline-block; float:right' onclick='showPostEdit(\"" + vo.contents + "\",\"" + vo.title + "\","+vo.trvSeq +")' class='sns-post-edit' data-postSeq='"+ vo.postSeq + "'><a/>" + 
                  "</div></div>";
...
"<p class='col-md-5' align='left'>" + vo.crtDate + "</p>" +
"</div>" +
"<div class='form-group' style='text-align:center; display:block; width:100%'>" +
"<a href='javascript:;'><img alt='삭제' src='/poorip/assets/images/delete-btn.png' style='width: 5%; display:inline-block; float:left' onclick='postDelete(" + vo.postSeq + ")'></a>" +
 "<a href='javascript:;'><img alt='공유' src='/poorip/assets/images/share-btn.png' style='width: 5%; display:inline-block;' ></a>" +
 "<a href='#sns-edit-form' id='edit-form-tag'><img alt='수정' src='/poorip/assets/images/write-btn.png' style='width: 5%; display:inline-block; float:right' onclick='showPostEdit(\"" + vo.contents + "\",\"" + vo.title + "\","+vo.trvSeq +")'></a>" + 
"</div>" ;
...
function showPostEdit(contents, title, trvSeq) {
	$("#sns-write").hide();	
	$("#sns-edit").show();
	writeVisible = true;
