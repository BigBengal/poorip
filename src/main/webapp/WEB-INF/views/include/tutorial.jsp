...
<div class="container" id="contents"  data-spy="scroll" data-target="#myScrollspy" data-offset="20">
	<div class="row">
		<!-- 		<div class="col-md-2"> -->
		<!-- 		<div id="top"> -->
		<!-- 			<p>도움말</p> -->
		...
		<div class="col-sm-12">
			<nav class="col-sm-3" id="myScrollspy">
				<ul class="nav nav-pills nav-stacked">
					<!--         <li class="active dropdown-toggle" data-toggle="dropdown"><a href="#travel">여행방법<span class="caret"></span></a></li> -->
					<!--         <li><a href="#matching">matching 방법</a></li> -->
