...
<div class="row object-non-visible " data-animation-effect="fadeIn">
	<div class="container">
		<div class="block"  style="padding-top: 30px" id="sns-edit-form" >
			<form class="form-horizontal" id="sns-edit-ajax" action="${pageContext.request.contextPath}/sns/editPost" method="post" enctype="multipart/form-data">
					...
					<div class="write-main block" id="sns-edit" style="display:none;">
						...
						<div class="form-group-button">
							<div class="col-md-12" style="padding-left: 40%">
								<button type="submit"
									class="btn btn-default col-lg-6 center-block" id="sns-edit-button" >수정하기</button>
							</div>
						</div>
					</div>
